...
class RotateButton {
	...
	static createButton( renderer, buttonLabel, posX, posY, surfaceGroup, scene, rotateAxis, sessionInit = {} ) {
		...
		function showStartAR( /*device*/) {
			...
			// button.style.top = 'calc(50% - '+posX+'px)';
			// button.style.bottom = 'calc(50% - '+posX-10+'px)';
